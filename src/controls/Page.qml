...
T2.Page {
    ...
    Loader {
        ...
        active: row && (row.layers.depth > 1 || row.globalToolBar.actualStyle == Kirigami.ApplicationHeaderStyle.ToolBar || globalToolBar.row.globalToolBar.actualStyle == Kirigami.ApplicationHeaderStyle.Titles)
